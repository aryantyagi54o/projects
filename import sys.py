...
from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QVBoxLayout, QLabel, QLineEdit, QMessageBox, QFileDialog, QTextEdit, QHBoxLayout
...
class GaitRecognitionApp(QWidget):
    ...
    def process_video(self, file_path):
        ...
        while cap.isOpened():
            ...
            if results.pose_landmarks:
                ...
                landmarks = [landmark.x for landmark in results.pose_landmarks.landmark] + [landmark.y for landmark in results.pose_landmarks.landmark]
    ...
    def authenticate_user(self, landmarks):
        ...
        live_features = [landmark.x for landmark in landmarks.landmark] + [landmark.y for landmark in landmarks.landmark]
